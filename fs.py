...
genOutput     =  {'clasdis': 'clasdis.dat', 'claspyth': 'claspyth.dat', 'dvcsgen': 'dvcsgen.dat', 'genKYandOnePion': 'genKYandOnePion.dat', 'inclusive-dis-rad':'inclusive-dis-rad.dat' , 'JPsiGen':'JPsiGen.dat', 'TCSGen':'TCSGen.dat', 'twopeg':'twopeg.dat', 'clas12-elSpectro':'clas12-elSpectro.dat', 'gemc': 'gemc'}
genExecutable =  {'clasdis': 'clasdis'  ,   'claspyth': 'claspyth',     'dvcsgen': 'dvcsgen'    , 'genKYandOnePion': 'genKYandOnePion'    , 'inclusive-dis-rad':'inclusive-dis-rad',      'JPsiGen':'JPsiGen',     'TCSGen':'TCSGen',     'twopeg':'twopeg', 'clas12-elSpectro':'clas12-elSpectro',    'gemc': 'gemc'}

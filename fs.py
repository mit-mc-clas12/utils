...
genOutput     =  {'clasdis': 'clasdis.dat', 'MCEGENpiN_radcorr': 'MCEGENpiN_radcorr.dat', 'claspyth': 'claspyth.dat', 'dvcsgen': 'dvcsgen.dat', 'genKYandOnePion': 'genKYandOnePion.dat', 'inclusive-dis-rad':'inclusive-dis-rad.dat' , 'JPsiGen':'JPsiGen.dat', 'TCSGen':'TCSGen.dat', 'twopeg':'twopeg.dat', 'clas12-elSpectro':'clas12-elSpectro.dat', 'deep-pipi-gen': 'deep-pipi-gen.dat', 'gemc': 'gemc'}
genExecutable =  {'clasdis': 'clasdis'  ,   'MCEGENpiN_radcorr': 'MCEGENpiN_radcorr',     'claspyth': 'claspyth',     'dvcsgen': 'dvcsgen'    , 'genKYandOnePion': 'genKYandOnePion'    , 'inclusive-dis-rad':'inclusive-dis-rad',      'JPsiGen':'JPsiGen',     'TCSGen':'TCSGen',     'twopeg':'twopeg',     'clas12-elSpectro':'clas12-elSpectro',     'deep-pipi-gen': 'deep-pipi-gen',     'gemc': 'gemc'}
